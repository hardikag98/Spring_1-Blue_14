...
#	C0 - ASC	:   8.5258 
#	C1 - GLNCY: 69.6149
#	C2 - PDD	:   3.21747e-08 ~ essentially do not invest anything in PDD
#	C3 - ROST:  19.7577
#	C4 - TH:    2.10162
...
# iterate over 0.03 -> 0.621 returns, since this is the range of the means - 100 values

returns = np.linspace( 0.03, 0.621, 100)
